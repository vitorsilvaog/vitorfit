...
const BASE_LIBRARY: LibraryExercise[] = FAMILIAS.flatMap((f) =>
  f.ejercicios.map(([nombre, equipo], idx) => ({
    ...
    tipo: f.tipo,
    icono: f.icono,
    demo_url: nombre === "Press Banca"
      ? "https://gfklswkapmhumpjkgvao.supabase.co/storage/v1/object/public/exercise-demos/press-banca.mp4"
      : undefined,
  }))
);
...
{ex.demo_url&&<details className="vf-demo"><summary>🎬 VER DEMOSTRACIÓN EN MOVIMIENTO</summary><div className="vf-demo-wrap"><video className="vf-demo-video" src={ex.demo_url} autoPlay loop muted playsInline preload="metadata" controls/><div className="vf-demo-label"><span className="vf-demo-live">● DEMO VITORFIT</span><span>Reproducción en bucle</span></div></div></details>}
