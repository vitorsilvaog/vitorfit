  ...
  const Anatomia = ({ musculo }: { musculo: string }) => {
    ...
    return <div className="vf-anatomy" title={`Zona principal: ${musculo}`}>
      <svg viewBox="0 0 120 180" role="img" aria-label={`Músculos trabajados: ${musculo}`}>
        <defs><linearGradient id="skin" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#f0f0f0"/><stop offset=".55" stopColor="#9b9b9b"/><stop offset="1" stopColor="#4b4b4b"/></linearGradient></defs>
    ...
    <main className="vf-app">
      <style>{`
        *{box-sizing:border-box} body{margin:0;background:#020402} button,input,select{font:inherit}
        ...
        .vf-anatomy{width:82px;min-width:82px;text-align:center;color:#8DFF00;font-size:8px;font-weight:900;text-transform:uppercase}.vf-anatomy svg{display:block;width:64px;height:78px;margin:auto;filter:drop-shadow(0 0 7px rgba(141,255,0,.12))}.vf-anatomy .an-body{fill:url(#skin);stroke:#202020;stroke-width:1.5}.vf-anatomy .an-muscle{fill:transparent;stroke:transparent;stroke-width:1}.vf-anatomy .an-muscle.active{fill:#e32121;stroke:#7b0000;filter:drop-shadow(0 0 2px rgba(255,25,25,.65))}.vf-anatomy .an-detail{fill:none;stroke:#343434;stroke-width:1;opacity:.8}.vf-pause{margin-top:9px;border:1px solid #8DFF00;background:#0a1107;color:#8DFF00;border-radius:8px;padding:6px 10px;font-size:10px;font-weight:1000;cursor:pointer}.vf-pause.paused{background:#8DFF00;color:#050805}.vf-lib-top{display:grid;grid-template-columns:1fr auto;gap:8px;align-items:center}.vf-lib-muscle{color:#ff3b3b;font-size:10px;font-weight:1000;text-transform:uppercase;margin-top:4px}
